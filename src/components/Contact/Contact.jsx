      ...
      <div className="container" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
        <div className="row d-flex">
          <div className="col-lg-6">
            ...
            <div id="st-alert"></div>
            <form action="https://formspree.io/f/xgvweeej" method="POST">
              ...
              <button className='st-btn st-style1 st-color1' type="submit">Send Message</button>
            </form>
            ...
            <div className="st-contact-info-wrap">
              <div className="st-single-contact-info">
                ...
                <div className="st-single-info-details">
                  <h4>Email</h4>
                  <Link to="#">freij.akram@gmail.com</Link>
                </div>
              </div>
              <div className="st-single-contact-info">
                <div className="st-icon-wrap">
